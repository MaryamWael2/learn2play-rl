...
class Obstacle:
    def __init__(self, screen_width, obstacle_speed=20):
        self.screen_width = screen_width
        self.obstacle = pygame.image.load(os.path.join(".", "src", "env", "assets", "obstacle.png"))
