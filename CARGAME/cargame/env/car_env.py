...
class CarGameAI:
    def __init__(self, width=900, height=600, obstacle_speed=20, max_obstacles=7):
        ...
        # self.bg = pygame.image.load(os.path.join(".", "cargame", "env", "assets", "road.jpg"))
        # self.bg = pygame.transform.scale(self.bg, (width, height))
        self.reset()
    
    def reset(self):
        pygame.display.set_caption("Car Game")
        pygame.display.set_icon(pygame.image.load(os.path.join(".", "cargame", "env", "assets", "car.png")))
        self.score = 0
        self.direction = Direction.LEFT
        
        self.car = pygame.image.load(os.path.join(".", "cargame", "env", "assets", "car.png"))
        ...
        self.obstacles = []    
        self.obstacles.append(Obstacle(self.screen, self.width, self.obstacle_speed))
    ...
    def play(self, action):
        ...
        self.update_car()
        # self.show_score()
        self.pixel_array = pygame.surfarray.array3d(self.screen)
        pygame.display.flip()
